                      ...
                      Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            FittedBox(child: Text('DELIVERY APP - LOGIN',style: TextStyle(fontFamily: 'Anton' , fontWeight: FontWeight.bold,fontSize: 20),)),
                          ],
                        ),
                      ),
                      SizedBox(height: 20,),
                          ...
                          child: FlatButton(
                              ...
                              onPressed:(){
                                if(_formKey.currentState!.validate()){
                                  ...
                                  _firebaseServices.validateUser(email).then((value) {
                                          if(value.exists){
                                            if(value['password']==password){
                                              _authData.loginBoy(email, password).then((credential){
                                                if(credential!=null){
                                                  EasyLoading.showSuccess('Successfully logged in').then((value) {
                                            ...
                                            EasyLoading.showError('$email dose not registered as our Delivery Boy');
